...
GSIBV.Map = class extends MA.Class.Base {
  ...
  initializeMap(options) {
    ...
    var mapOptions = {
      container: this._container, //修正　200214
      style: {
        "version": 8,
        "layers": [],
        "sources": {},
    ...
    */
    ...
    var mapright = new mapboxgl.Map({
      ...
      center: this._startUp.center, // starting position [lng, lat]
      zoom: this._startUp.zoom, // starting zoom
      localIdeographFontFamily: ['MS Gothic', 'sans-serif']
    });
    
//    var comparecontainer = '#mapscompare';
    var comparecontainer = '#map';
    
    new mapboxgl.Compare(map, mapright, comparecontainer, {
